    ...
    return (
        ...
        dark:border-stone-700">
            <li className="mb-10 ml-4">
                ...
                <div className="transition duration-200 ease-in hover:-translate-y-1 hover:translate-x-1">
                ...
                <p className="my-2 text-base font-normal text-stone-400 dark:text-stone-400">
                    {details}
                </p>
                </div>
            </li>
